...
for i in range(height):
    for j in range(int(width/2)):
        ...
        tempPixel.append((Pixel[3*i*width+6*j] + Pixel[3*i*width+6*j+3])/2-Pixel[3*i*width+6*j+3])
        
        newPixel.append((Pixel[3*i*width+6*j+1] + Pixel[3*i*width+6*j+4])/2)
        tempPixel.append((Pixel[3*i*width+6*j+1] + Pixel[3*i*width+6*j+4])/2-Pixel[3*i*width+6*j+4])
        
        newPixel.append((Pixel[3*i*width+6*j+2] + Pixel[3*i*width+6*j+5])/2)
        tempPixel.append((Pixel[3*i*width+6*j+2] + Pixel[3*i*width+6*j+5])/2-Pixel[3*i*width+6*j+5])
...
for m in range(int(height/2)):
    for n in range(width):
        ...
        tempPixel.append(newPixel[2*m*3*width+3*n] - (newPixel[2*m*3*width+3*n] + newPixel[2*m*3*width+3*n+3*width])/2)
        
        newPixelaveH.append((newPixel[2*m*3*width+3*n+1] + newPixel[2*m*3*width+3*n+3*width+1])/2)
        tempPixel.append(newPixel[2*m*3*width+3*n+1] - (newPixel[2*m*3*width+3*n+1] + newPixel[2*m*3*width+3*n+3*width+1])/2)
        
        newPixelaveH.append((newPixel[2*m*3*width+3*n+2] + newPixel[2*m*3*width+3*n+3*width+2])/2)
        tempPixel.append(newPixel[2*m*3*width+3*n+2] - (newPixel[2*m*3*width+3*n+2] + newPixel[2*m*3*width+3*n+3*width+2])/2)
